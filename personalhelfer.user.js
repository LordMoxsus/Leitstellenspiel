...
(async function() {
    ...
    $.get('/buildings/' + buildingId + '/hire', function(data){
        ...
        $('div[class="btn-group pull-right"]')
            ...
            .append(`<br>
                     <a id="hire_do_1" class="btn btn-default btn-xs" style="display:${!hire ? `` : `none`}">1 Tag werben</a>
                     <a id="hire_do_2" class="btn btn-default btn-xs" style="display:${!hire ? `` : `none`}">2 Tage werben</a>
                     <a id="hire_do_3" class="btn btn-default btn-xs" style="display:${!hire ? `` : `none`}">3 Tage werben</a>
                     <a id="hire_do_0" class="btn btn-danger btn-xs" style="display:${hire ? `` : `none`}">Einstellungsphase abbrechen</a>
                     <a id="hire_do_automatic" class="btn btn-default btn-xs" style="display:${user_premium && !hire ? `` : `none`}">automatisch</a>
